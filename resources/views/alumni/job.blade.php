        ...
        <div class="col-lg-8 mx-auto">
            <div class="card shadow">
                ...
                <div class="card-body p-4 pt-2 pb-0">
                    <form type="get" action="{{ url('alumni/search-job') }}">
                    ...
                    <div style="text-align: right;" class="pt-3">
                        <a href="{{ url('alumni/job') }}" class="btn btn-info" type="button" data-bs-toggle="modal"
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="{{ route('alumni.job.update', $job->id) }}"
                                                    id="editForm">
                                                    {!! csrf_field() !!}
                                                    @method('PATCH')
                                                    <div class="row">
                                ...
                                <div class="modal fade" id="destroy{{ $job->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{ route('alumni.job.destroy', $job->id) }}"
    ...
    <div class="modal fade" id="jobModal" tabindex="-1" aria-labelledby="modalForJob" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('alumni/job') }}" method="post">
                        {!! csrf_field() !!}
                        <div class="row">
                            <div class="control-group col-12">
