    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-7">
                <div class="card-body px-0 pt-0 pb-2">
                    <div style="text-align: right; ">
                        <a href="{{ url('/alumni/forum') }}" class="btn btn-info" type="button" data-bs-toggle="modal"
                                ...
                                @foreach ($forums as $forum)
                                    <div class="container-fluid">
                                        <div class="row">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST"
                                                                action="{{ route('alumni.forum.update', $forum->id) }}"
                                                                id="editForm">
                                                                {!! csrf_field() !!}
                                                                @method('PATCH')
                                                                <div class="row">
                                            ...
                                            <!-- Delete Forum Modal -->
                                            <div class="modal fade" id="destroy{{ $forum->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="POST"
                                                            action="{{ route('alumni.forum.destroy', $forum->id) }}"
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" class="btn btn-danger"
                                                                    title="Delete Post"><i class="fa fa-trash-o"
                                        ...
                                        <div class="card-header pb-0 pt-3" style="text-align: center; ">
                                            ...
                                            @if (count($forum->replies))
                                                ...
                                                <!-- Edit Reply Modal -->
                                                <div class="modal fade" id="editReply{{ $reply->id }}"
                                                    tabindex="-1" aria-labelledby="modalForReplyEdit"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="POST"
                                                                    action="{{ route('alumni.reply.update', $reply->id) }}"
                                                                    id="editForm">
                                                                    {!! csrf_field() !!}
                                                                    @method('PATCH')
                                                                    <div class="row">
                                                ...
                                                <div class="modal fade"
                                                    id="destroyReply{{ $reply->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="POST"
                                                                action="{{ route('alumni.reply.destroy', $reply->id) }}"
                                                                id="editForm" accept-charset="UTF-8"
                                                                style="display:inline">
                                                                {{ method_field('DELETE') }}
                                                                {{ csrf_field() }}
                                                                <div class="modal-body">
                                                                    ...
                                                                    <h5 class="text-center pr- text-sm">
            ...
            @else
                ...
                <!-- Forum reply-->
                <form action="{{ url('alumni/reply', $forum->id) }}" method="post">
                    {!! csrf_field() !!}
...
<div class="modal-body">
    <form action="{{ url('alumni/forum') }}" method="post">
        {!! csrf_field() !!}
        <div class="row">
            <div class="control-group col-12 mt-2">
...
<div class="modal-body">
    <form action="{{ url('alumni.reply.store', $forum->id) }}" method="post">
        {!! csrf_field() !!}
        <div class="row">
            <div class="control-group col-12 mt-2">
