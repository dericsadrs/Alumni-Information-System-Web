...
@section('content')
    ...
    <div class="container-fluid">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{ route('job.destroy', $job->id) }}"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <h5 class="text-center pr- text-sm">Name: {{ $job->title }}</h5>
                                                    <h5 class="text-center pr- text-sm">Description: {{ $job->content }}
                                                    </h5>
                                                </div>
                                                <div class="modal-footer">
                                                    <a href="#"><button type="button" class="btn btn-secondary"
        ...
        @endforeach
        @else 
        <h2 class="text-center text-secondary p-4">No Results Found!</h2>
        @endif
